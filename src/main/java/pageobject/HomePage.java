...
public class HomePage {
  ...
  /*  public void fill_MultiCityTripdetails( Map<String,String> map){
    ...
    public void fill_Tripdetails( Map<String,String> map,String tripSelection) throws InterruptedException {
        ...
        enter_departdate(departdate);}
        if(!tripSelection.equals("OneWay")&&!tripSelection.equals("Multicity")){ enter_ReturnOn(returnDate);
        if(!tripSelection.equals("RoundTrip")&&!tripSelection.equals("OneWay")){
  ...
  /*  public void fill_Onewaydetails( Map<String,String> map,String string){
        enter_From(map.get("From"));
        enter_To("To");
        enter_departdate();
        SelectDropdown(map.get("Adult"),"Adults");
        SelectDropdown(map.get("Children"),"Childrens");
    ...
    @FindBy(xpath="//*[@id='block_top_menu']") public WebElement oneway;

    @FindBy(xpath="//*[@id='RoundTrip']") public WebElement roundTrip;
    @FindBy(xpath="//*[@id='MultiCity']") public WebElement multicity;
    @FindBy(xpath="//*[@id='FromTag' or @tabindex='5']") public WebElement from;

    @FindBy(xpath="//*[@id='ToTag']") public WebElement to;

    @FindBy(xpath="//*[@id='FromTag1']") public WebElement from1;
    @FindBy(xpath="//*[@id='ToTag1']") public WebElement to1;

    @FindBy(xpath="//*[@id='FromTag2']") public WebElement from2;
    @FindBy(xpath="//*[@id='ToTag2']") public WebElement to2;

    @FindBy(xpath="//*[@id='FromTag3']") public WebElement from3;
    @FindBy(xpath="//*[@id='ToTag3']") public WebElement to3;

    @FindBy(xpath="//*[@id=\"DepartDate1\"]") WebElement departdate1;

    @FindBy(xpath="//*[@id=\"DepartDate2\"]") WebElement departdate2;

    @FindBy(xpath="//*[@id=\"DepartDate3\"]") WebElement departdate3;

    @FindBy(xpath="//*[@id=\"DepartDate\"]") WebElement departdate;
    @FindBy(xpath="//*[@id='ReturnDate']") WebElement returnDate;
    @FindBy(xpath="//*[@id='Adults']") public WebElement adults;
    @FindBy(xpath="//*[@id='Childrens']") public WebElement children;
    @FindBy(xpath="//*[@id='MoreOptionsLink']") WebElement MoreOptionsLink;
    @FindBy(xpath="//*[@id='Class']") public WebElement classofTravel;
    @FindBy(xpath="//*[@id='SearchBtn']") public WebElement SearchBtn;
    @FindBy(xpath="//*[@id='block_top_menu']") WebElement PreferredAirline;
    @FindBy(xpath="//*[text()=20]") WebElement CalendarDateSelection;
